      ...
      <div className="bg-slate-900 rounded-2xl p-6 text-white overflow-hidden relative">
        ...
        <div className="relative z-10">
          ...
          <p className="text-[11px] text-slate-300 leading-relaxed mb-6">
            Please ensure your declaration is accurate. Prohibited items (e.g.,
            explosives, narcotics) are strictly forbidden. Restricted items
            (e.g., liquids, batteries, chemicals) may be allowed if properly
            declared and accompanied by necessary documentation. For a complete
            list and details, please refer to our{" "}
            <a
